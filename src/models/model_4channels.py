...
class Attention(nn.Module):
    def __init__(self, num_classes=19, cnn='resnet34', attention_size=8):
        super().__init__()
...
class AttentionInceptionV3(nn.Module):
    def __init__(self, num_classes=19, attention_size=8, aux_attention_size=8):
        super().__init__()
        self.num_classes = num_classes
...
def get_attention_inceptionv3(num_classes=19, **kwargs):
    return AttentionInceptionV3(num_classes=num_classes, **kwargs)


def get_attention(num_classes=19, **kwargs):
    return Attention(num_classes=num_classes, **kwargs)


def get_resnet34(num_classes=19, **_):
    model_name = 'resnet34'
    model = timm.create_model('resnet34', pretrained=True, num_classes=19)
    conv1 = model.conv1
...
def get_resnet18(num_classes=19, **_):
    model_name = 'resnet18'
    model = timm.create_model('resnet18', pretrained=True, num_classes=19)
    conv1 = model.conv1
    model.conv1 = nn.Conv2d(in_channels=4,
                            out_channels=conv1.out_channels,
                            kernel_size=conv1.kernel_size,
...
def get_senet(model_name='seresnext50_32x4d', num_classes=19, **_):
    model = timm.create_model(model_name, pretrained=True, num_classes=19, features_only=True)
    conv1 = model.conv1
    model.conv1 = nn.Conv2d(in_channels=4,
                                   out_channels=conv1.out_channels,
                                   kernel_size=conv1.kernel_size,
...
def get_se_resnext50(num_classes=19, **kwargs):
